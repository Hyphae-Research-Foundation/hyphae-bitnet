...
> [!IMPORTANT]
> This repository is the pinned Celiums BitNet runtime fork used by
> [Celiums BitNet](https://github.com/celiumsai/celiums-bitnet). It is based on
> llama.cpp and the Microsoft BitNet integration branch. Celiums-specific work
> includes strict I2_S numerical corrections, SIMD and scalar kernels, GGUF
> validation, phase-aware threadpools, and regression tests. It is not an
> official ggml-org or Microsoft repository.

The upstream llama.cpp code remains under the MIT License in `LICENSE`.
Copyright 2026 Celiums Solutions LLC applies only to Celiums modifications.
